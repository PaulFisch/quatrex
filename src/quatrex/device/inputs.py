...
# --- Full-matrix (phonon-pipeline) input path -----------------------------
# The functions below keep the original full-matrix semantics (matrix_dict
# entries are complete matrices, not upper-triangular halves) used by the
