...
\begin{enumerate}
  \item Truncated matricisation SVD, i.e.\ the classical matrix SVD applied to a matricisation of
        the tensor: fully algebraic and Eckart--Young optimal in the chosen matricisation, but
...
% ----------------------------------------------------------------------
\subsubsection{Truncated matricisation SVD}
