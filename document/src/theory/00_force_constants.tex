...
% REVIEW: togo_first_2015 is the phonopy (Scripta Mater.) review; phono3py is a
% separate Togo 2015 paper. togo_implementation_2023 is the phono3py-specific ref.
...
\begin{equation}\label{eq:fc3_indscal_params}
  ...
  \;=\; \cO\!\bigl(R\,\Ncell\,\nprim\bigr),
\end{equation}
% REVIEW: imprecise -- both INDSCAL and CP are O(R*ndof); merging b_r=c_r removes
% one ndof-length vector per term (a ~2x constant factor), not a factor of ndof.
