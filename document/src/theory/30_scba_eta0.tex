...
Applied to the bubble legs this is both unnecessary and harmful. The cubic matrix
element carries $|V_3|^2\propto\omega_1\omega_2\omega_3$, so the soft-leg factor
offsets the absorption pole; equivalently the acoustic spectral weight vanishes
linearly, $A(\omega')\to A'(0)\,\omega'$, so the equilibrium lesser function
$G^{<}_{\rm eq}=-i\,nA$ stays finite. Out of equilibrium the bosonic fold
