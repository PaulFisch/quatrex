#!/usr/bin/env bash
# Parallel VASP over the 60 small-rattle SrTiO3 disp dirs, 8 wide.
cd /usr/scratch/mont-fort11/pfischill/quatrex/phonon/configs/perovskite/fc3_hiphive_srtio3_small_vasp || exit 1
