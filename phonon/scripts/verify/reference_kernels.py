...
the validation scripts can cross-check the production kernel against an
...
Used by se_q_validate.py, phph_q_comm_validate.py, se_q_vs_phono3py_gamma.py,
se_q_vs_phono3py_modes.py, and verify_gamma_opt.py.
"""
